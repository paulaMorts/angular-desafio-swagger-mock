...
var _getChassi = function () {
    return ""+_getRandomNumber(999999999999999999);
};
...
var _getRandomName = function () {
    return _firstNameList[_getRandomNumber(_firstNameList.length)] + " " + _lastNameList[_getRandomNumber(_lastNameList.length)];
};
...
var _getRandomCompanyName = function () {
    return _firstCompanyNameList[_getRandomNumber(_firstCompanyNameList.length)] + " " + _lastCompanyNameList[_getRandomNumber(_lastCompanyNameList.length)];
};

module.exports = {
    randomDate: _randomDate,
    getCPF: _getCPF,
    getChassi: _getChassi,
